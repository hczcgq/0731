package com.chen.listview.library;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        case SUCCEED:
            ...
            refreshTimeTextView.setText(this.getContext().getString(
                    R.string.last_update_time, getCurrentDate()));
            break;
        case FAIL:
        default:
            // 刷新失败
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        case SUCCEED:
            ...
            loadTimeTextView.setVisibility(View.VISIBLE);
            loadTimeTextView.setText(this.getContext().getString(
                    R.string.last_update_time, getCurrentDate()));
            loadStateImageView
                    .setBackgroundResource(R.drawable.refresh_succeed);
            break;
        ...
        case MotionEvent.ACTION_MOVE:
            if (mEvents == 0) {
                if (pullDownY > 0
                    ...
                    // 可以下拉，正在加载时不能下拉
                    // 对实际滑动距离做缩小，造成用力拉的感觉
                    if (mMode == PULL_BOTH || mMode == PULL_UP) {
                    ...
                    if (mMode == PULL_BOTH || mMode == PULL_DOWN) {
                        // 可以上拉，正在刷新时不能上拉
    ...
    private void initView() {
        ...
        refreshTimeTextView = (TextView) refreshView.findViewById(R.id.tv_time);
        ...
        loadTimeTextView = (TextView) loadmoreView.findViewById(R.id.tv_time);
